	...
	class FrmMain : public Gtk::ApplicationWindow {
		...
		private:
			...
			std::mutex m_logMutex, m_signalMutex, m_settingsWriteMutex;
                        ...
                        std::vector<std::string> m_domeParkStatusNotificationMap = {
                            "domeParkStatusChangedToUnknown", "domeParkStatusChangedToParked",
                            "domeParkStatusChangedToParking", "domeParkStatusChangedToUnparking",
                        ...
                        std::vector<std::string> m_domeStatusNotificationMap = {
                            "domeStatusChangedToIdle", "domeStatusChangedToMovingClockwise",
                            "domeStatusChangedToMovingCounterClockwise", "domeStatusChangedToTracking",
                            "domeStatusChangedToParking", "domeStatusChangedToUnparking",
                        ...
                        std::vector<std::string> m_dustcapStatusNotificationMap = {
                            "dustcapStatusChangedToIdle", "dustcapStatusChangedToParking",
                            "dustcapStatusChangedToUnparking", "dustcapStatusChangedToParked",
